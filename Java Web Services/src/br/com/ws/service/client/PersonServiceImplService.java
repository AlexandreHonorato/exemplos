 ...
 * 
 */
@WebServiceClient(name = "PersonServiceImplService", targetNamespace = "http://service.ws.com.br/", wsdlLocation = "http://localhost:9876/personservice?wsdl")
    ...
    extends Service
{
    ...
    private final static QName PERSONSERVICEIMPLSERVICE_QNAME = new QName("http://service.ws.com.br/", "PersonServiceImplService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:9876/personservice?wsdl");
    ...
    public PersonServiceImpl getPersonServiceImplPort() {
        return super.getPort(new QName("http://service.ws.com.br/", "PersonServiceImplPort"), PersonServiceImpl.class);
    }
    ...
    public PersonServiceImpl getPersonServiceImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://service.ws.com.br/", "PersonServiceImplPort"), PersonServiceImpl.class, features);
    }
